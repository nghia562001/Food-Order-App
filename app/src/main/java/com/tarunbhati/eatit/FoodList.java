...
//                try {
//                    viewHolder.food_name.setText(R.string.class.getField(name + "_name_" + position).getInt(null));
//                } catch (IllegalAccessException | NoSuchFieldException e) {
//                    e.printStackTrace();
//                }

                String name = model.getName().replaceAll(" ", "").toLowerCase();
                System.out.println(name);
                int resource = getResources().getIdentifier("product_" + model.getMenuId() + "_" + name, "drawable", getPackageName());
                viewHolder.food_image.setImageResource(resource);
